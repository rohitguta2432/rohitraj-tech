...
function AgentCard({ agent, index, variant }: { agent: AgentShowcase; index: number; variant: "teaser" | "full" }) {
    const demoHref = variant === "full" ? "#try" : `/agents#try`;
    return (
            ...
            <div className="ai-project-body">
                <div className="ai-project-header">
                    ...
                    <div className="ai-project-meta">
                        ...
                        {agent.detailPath && (
                            <Link href={`${agent.detailPath}`} className="ai-project-repo">
...
export default function Agents({ variant = "teaser" }: AgentsProps) {
        ...
        <section id="agents" className="ai-projects-section">
            <div className="container">
                ...
                <div className="ai-projects-list">
                    {shown.map((agent, i) => (
                        <AgentCard key={agent.slug} agent={agent} index={i} variant={variant} />
                    ))}
                </div>
