...
If you are building an AI feature this quarter and want it wired with the caching, batch, and eval scaffolding that makes model upgrades a one-line change instead of a fire drill, that is exactly the work I do. I ship [6-week MVPs](/services/6-week-mvp) and take [founding-engineer engagements](/services/hire-founding-engineer-india) for teams building on Claude, and model-upgrade hygiene is table stakes in both. If your whole team codes with Claude daily, a [Claude Code consultant](/services/claude-code-consultant) engagement sets up the shared CLAUDE.md, skills, hooks, and guardrails so everyone gets the same results.`,
        },
    ],
    cta: {
