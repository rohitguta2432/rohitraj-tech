...
export const aiProjectSummaries: AIProjectSummary[] = [
    ...
    },
    {
        ...
        solution: "Ask one question in Hindi, Hinglish, English, or a regional language. A router agent picks the right specialist from six, pulls the live data its domain needs — real 7-day weather, real mandi prices — and streams back a short, practical answer in the farmer's own language — spoken aloud on request. Voice in, voice out, zero API keys.",
        techStack: ["FastAPI", "Python 3.11", "Next.js 16", "Ollama (qwen3:14b)", "Web Speech API", "Open-Meteo", "Agmarknet"],
